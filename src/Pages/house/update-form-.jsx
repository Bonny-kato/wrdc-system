...
const UpdateForm = ({onSubmit, isUpdating, setIsOpen, house}) => {
    ...
    return (
        <form
            ...
            <p className={'text-xl font-semibold text-skin-base'}>Update House Infomation </p>
            <div className={'grid grid-cols-2 gap-4 pt-5'}>
                <FieldWrapper>
                    <Input
                        defaultValue={house.identificationNumber}
                        register={register}
                        label={'house number'}
                        name={'houseNumber'}/>
                </FieldWrapper>
                ...
                <FieldWrapper>
                    <Input
                        defaultValue={house.owner.fullName}
                        register={register}
                        label={'house owner'}
                        name={'ownerFullName'}/>
                </FieldWrapper>
                ...
                <FieldWrapper>
                    <Input
                        defaultValue={house.owner.phoneNumber}
                        register={register}
                ...
                <FieldWrapper>
                    <Input
                        defaultValue={house.owner.email || ''}
                        required={false}
                        register={register}
                        label={'owner email'}
                        name={'ownerEmail'}/>
                ...
                <FieldWrapper>
                    <Select
                        defautlValue={house.owner.gender}
